...
function buildProviders(args) {
    var tracerProvider = new sdk_trace_base_1.BasicTracerProvider({
    ...
    var traceExporter = new exporter_trace_otlp_http_1.OTLPTraceExporter({ url: args.tracesUrl, headers: args.headers });
    ...
    var meterProvider = new sdk_metrics_1.MeterProvider({ resource: args.resource });
    if (args.metricsUrl) {
        var metricExporter = new exporter_metrics_otlp_http_1.OTLPMetricExporter({ url: args.metricsUrl, headers: args.headers });
    ...
    return { tracerProvider: tracerProvider, meterProvider: meterProvider, shutdown: shutdown };
}
